...
urlpatterns = [
    ...
    path('sensors/<int:pk>/', views.SensorList.as_view(), name='sensor-detail'),
    path('sensors_type/', views.SensorTypeList.as_view()),
    path('sensors_type/<int:pk>/', views.SensorTypeList.as_view(), name='sensortype-detail'),
    path('data/upload/', views.DataUpload.as_view()),
    path('data/', views.DataList.as_view()),
    path('data/<int:pk>/', views.DataList.as_view(), name='data-detail'),
    path('data/<int:pk>/analysis/', views.Analyse.as_view()),
